describe('en-US/zh-CN basic e2e test', () => {
  it('init ui should have english elements', () => {
    ...
    cy.get(':nth-child(1) > .ant-picker > .ant-picker-input > input').should('have.attr', 'placeholder', 'Select date');
    cy.get(':nth-child(2) > .ant-picker > .ant-picker-input > input').should('have.attr', 'placeholder', 'Select time');
  ...
  it('change language to chinese elements', () => {
    ...
    // input should have placeholder
    cy.get(':nth-child(1) > .ant-picker > .ant-picker-input > input').should('have.attr', 'placeholder', '请选择日期');
    cy.get(':nth-child(2) > .ant-picker > .ant-picker-input > input').should('have.attr', 'placeholder', '请选择时间');
